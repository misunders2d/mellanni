...
#         sheet = st.selectbox('Select a sheet with data')
#         file = pd.read_excel(sheets, sheet_name=sheet)
...
if st.button('Test'):
    st.session_state.file = read_file()
