...
def sqp_analyze(file):
    ...
    file.loc[file[f'Purchases: {st.session_state.entity} Count'],f'{st.session_state.entity} Conversion'] = file[f'Purchases: {st.session_state.entity} Count'] / file[f'Clicks: {st.session_state.entity} Count'].fillna(0)
