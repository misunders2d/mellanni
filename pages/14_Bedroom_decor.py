...
input_area = st.empty()
mode = selector_area.radio('Select editing mode', ['Full revision','Image edit'], horizontal=True, index = 1, captions = ['Suggest total changes','Apply changes to your exact image'])
